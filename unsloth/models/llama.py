...
def LlamaAttention_fast_forward_inference(
    ...
    if do_prefill:
        self.paged_attention = torch.empty((KV_CACHE_INCREMENT+seq_len+1, 2, bsz, n_kv_heads, head_dim), dtype = dtype, hidden_states.device)
        ...
        if HAS_FLASH_ATTENTION_SOFTCAPPING and attention_mask is None:
            ...
            if HAS_FLEX_ATTENTION:
                ...
                self.SWA_mask = AttentionMaskConverter(
                    ...
                    .to_causal_4d(1, n, n, dtype = inputs_embeds.dtype, device = inputs_embeds.device,)\
                    .squeeze(0).squeeze(0)
            ...
            if check_all:
                ...
                if "embed_tokens" in new_target_modules:
                    ...
                    model.model.model.embed_tokens.modules_to_save.default\
                        .to(dtype=(dtype if (dtype != torch.float16) else torch.float32), non_blocking = True)
